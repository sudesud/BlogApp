...
const BlogTableItem = ({blog,fetchBlogs,index}) => {
    ...
    const deleteBlog=async ()=>{
      const confirm =window.confirm('Are you sure tou want to delete this blog?')
      if(!confirm) return;
      try {
  ...
  return (
      ...
      <tr className='border-y border-gray-300'>
        ...
        <td className='px-2 py-4 flex text-xs gap-3'>
            ...
            <img onClick={deleteBlog} src={assets.cross}  className='w-8 hover:scale-110 transition-all cursor-pointer'  alt="" />
        </td>
      </tr>
