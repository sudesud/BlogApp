    ...
    <div className='mx-8 sm:mx-16 xl:mx-24 relative'>
      <div className=' text-center mt-20 mb-8'>
        ...
        mb-4 border border-primary/40 bg-primary/10 rounded-full text-sm text-primary'>
            ...
            <img src={assets.star} alt="" className='w-2.5' />
        </div>
       ...
       <p className='my-6 sm:my-8 max-w-2xl m-auto max-sm:text-xs text-gray-500'>This is your space to think out loud,to share what matters,and to write witout filters.
        Whether it's one word or thosund,your story starts right here.</p>
      ...
      <img src={assets.background} alt="" className='absolute -top-50 -z-1 opacity-50' />
    </div>
  )
}
